    ...
    return AppBar(
      ...
      actions: <Widget>[
        Icon(
          ...
          size: 30,
          color: Color.fromARGB(255, 247, 130, 107),
        ),
        ClipRRect(
      ...
      child: TextField(
        decoration: InputDecoration(
          ...
          suffixIcon: SizedBox(
              width: 50,
              child:
                  Icon(Icons.search, color: Color.fromARGB(255, 247, 130, 107))
                      .alignCenter
      ...
      children: <Widget>[
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              Text("Support Group", style: TextStyles.title.bold),
              Text(
                "See All",
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: <Widget>[
              _categoryCard("Addiction", "51 members",
                  color: LightColor.green, lightColor: LightColor.lightGreen),
              _categoryCard("Physical Disabilities", "23 members",
                  color: LightColor.skyBlue, lightColor: LightColor.lightBlue),
              _categoryCard("Mental Disabilities", "35 members",
                  color: LightColor.orange, lightColor: LightColor.lightOrange),
              _categoryCard("Cancer Recovery", "13 members",
                  color: LightColor.green, lightColor: LightColor.lightGreen),
              _categoryCard("PTSD ", "63 members",
                  color: LightColor.skyBlue, lightColor: LightColor.lightBlue)
            ],
          ),
        ),
